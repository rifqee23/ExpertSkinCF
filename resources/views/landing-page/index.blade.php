...
@section('content')
    @include('components.navbar')
     ...
     <!-- Hero Section -->
    <div id="home" class="relative bg-cover bg-center h-screen" style="background-image: url('/assets/img/10167.jpg');">
        <!-- Overlay -->
    ...
    <section id="team" class="py-20 mt-40 px-4 md:px-8 lg:px-16 bg-sky-700">
        ...
        <div class="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 max-w-screen-lg mt-16 mx-auto">
            ...
            <div class="flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="assets/img/arkaan.jpg" alt="Anggota Tim 1" class="w-full h-48 object-cover">
                <div class="p-6 text-center">
                    <h3 class="text-lg font-semibold text-sky-700">M. Faruq Arkaan</h3>
                    <p class="text-sky-600 font-light">Front - End</p>
                    <p class="mt-4 text-gray-600">"Saya sangat senang bekerja dengan tim ini dan menciptakan solusi inovatif!"</p>
                </div>
            </div>
            <!-- Anggota Tim 2 -->
            <div class="flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="assets/img/sana.jpg" alt="Anggota Tim 2" class="w-full h-48 object-cover">
                <div class="p-6 text-center">
                    <h3 class="text-lg font-semibold text-sky-700">Yunnisa Diah P</h3>
                    <p class="text-sky-600 font-light">Front - End</p>
                    <p class="mt-4 text-gray-600">"Mendesain antarmuka yang ramah pengguna adalah passion saya!"</p>
                </div>
            </div>
            <!-- Anggota Tim 3 -->
            <div class="flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="assets/img/swafoto.jpeg" alt="Anggota Tim 3" class="w-full h-48 object-cover">
                <div class="p-6 text-center">
                    <h3 class="text-lg font-semibold text-sky-700">M. Rifqi Febrianto</h3>
                    <p class="text-sky-600 font-light">Back - End</p>
                    <p class="mt-4 text-gray-600">"Berkolaborasi dalam proyek-proyek inovatif benar-benar memberikan kepuasan." </p>
                </div>
            </div>
            <!-- Anggota Tim 4 -->
            <div class="flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="assets/img/teammember4.jpg" alt="Anggota Tim 4" class="w-full h-48 object-cover">
                <div class="p-6 text-center">
                    <h3 class="text-lg font-semibold text-sky-700">Joe Febrian Sinuraya</h3>
                    <p class="text-sky-600 font-light">Back - End</p>
                    <p class="mt-4 text-gray-600">"Mendorong kampanye yang berdampak untuk terhubung dengan audiens kami."</p>
                </div>
            </div>
        </div>
    </section>
